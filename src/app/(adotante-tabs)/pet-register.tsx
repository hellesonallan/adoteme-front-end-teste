...
export default function PetRegister() {
  ...
  return (
    <ScrollView className="flex-1 bg-white px-4 py-6">
      <Text className="text-2xl font-bold mb-4 text-black">Cadastrar Pet</Text>
      ...
      <TouchableOpacity onPress={selecionarImagem} className="items-center mb-4">
        {imagem ? (
          ...
          <View className="w-full h-64 bg-black/5 rounded-xl border border-dashed border-black/20 justify-center items-center">
      ...
      <View className="gap-4">
        ...
        <View>
          ...
          <View className="border border-black/10 bg-black/5 rounded-xl">
